...
export default function AutorisationsPage() {
  ...
  const { data, isLoading }    = useResource<any>('administratif', { page, search, type: 'autorisation' });
  ...
  const handleSubmit = async () => {
    await create.mutateAsync({ ...form, type: 'autorisation' });
    handleClose();
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Autorisations de Circulation</h2>
          <p className="text-sm text-gray-500 mt-1">Gestion des autorisations de circulation</p>
        </div>
      ...
      {/* Table */}
      <SearchFilter onSearch={setSearch} placeholder="Rechercher une autorisation..." filters={[]} />
      <DataTable
        columns={COLUMNS} data={data?.data || []} loading={isLoading}
        total={data?.total || 0} page={page} pages={data?.pages || 1}
        onPageChange={setPage} emptyMessage="Aucune autorisation trouvée"
      />
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg flex flex-col overflow-hidden">
            ...
            <div className="flex items-center justify-between px-6 py-5"
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white">Nouvelle Autorisation de Circulation</h3>
            ...
            <div className="overflow-y-auto max-h-[70vh] p-6 space-y-5">
              ...
              {/* Autorisation + Véhicule */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <IconLabel icon={ShieldCheck} color="#2563eb">Autorisation de circulation *</IconLabel>
                  <input type="text" name="reference" value={form.reference} onChange={handleChange}
                    placeholder="Libellé de l'autorisation"
