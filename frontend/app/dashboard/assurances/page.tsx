...
export default function AssurancesPage() {
  return <GenericPage title="Assurances" description="Gestion des assurances véhicules" resource="administratif" columns={COLS} createLabel="Nouvelle Assurance" searchPlaceholder="Rechercher une assurance..." />;
}
