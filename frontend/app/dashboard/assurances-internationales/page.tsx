  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Assurances Internationales</h2>
          <p className="text-sm text-gray-500 mt-1">Assurances pour le transport international</p>
        </div>
      ...
      {/* Table */}
      <SearchFilter onSearch={setSearch} placeholder="Rechercher une assurance internationale..." filters={[]} />
      <DataTable
        columns={COLUMNS} data={data?.data || []} loading={isLoading}
        total={data?.total || 0} page={page} pages={data?.pages || 1}
        onPageChange={setPage} emptyMessage="Aucune assurance internationale trouvée"
      />
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg flex flex-col overflow-hidden">
            ...
            <div className="flex items-center justify-between px-6 py-5"
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white">Nouvelle Assurance Internationale</h3>
            ...
            <div className="overflow-y-auto max-h-[75vh] p-6 space-y-5">
              ...
              <div className="border border-gray-100 rounded-xl p-4 space-y-4 bg-gray-50/50">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <IconLabel icon={Banknote} color="#f59e0b">TVA</IconLabel>
                    <div className="relative">
