  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Cartes Grises</h2>
          <p className="text-sm text-gray-500 mt-1">Historique et gestion des cartes grises</p>
        </div>
      ...
      {/* Table */}
      <SearchFilter onSearch={setSearch} placeholder="Rechercher une carte grise..." filters={[]} />
      <DataTable
        columns={COLUMNS} data={data?.data || []} loading={isLoading}
        total={data?.total || 0} page={page} pages={data?.pages || 1}
        onPageChange={setPage} emptyMessage="Aucune carte grise trouvée"
      />
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg flex flex-col overflow-hidden">
            ...
            <div className="flex items-center justify-between px-6 py-5"
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white">Nouvelle Carte Grise</h3>
