...
import {
  Plus, X, Landmark, Truck, Hash, Banknote,
...
const COLUMNS = [
  ...
  { key: 'montant',        label: 'Montant',    render: (v: number) => v != null ? `${Number(v).toFixed(2)} DH` : '—' },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Taxes</h2>
          <p className="text-sm text-gray-500 mt-1">Gestion des taxes et redevances</p>
        </div>
      ...
      {/* Table */}
      <SearchFilter onSearch={setSearch} placeholder="Rechercher une taxe..." filters={[]} />
      <DataTable
        columns={COLUMNS} data={data?.data || []} loading={isLoading}
        total={data?.total || 0} page={page} pages={data?.pages || 1}
        onPageChange={setPage} emptyMessage="Aucune taxe trouvée"
      />
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg flex flex-col overflow-hidden">
            ...
            <div className="flex items-center justify-between px-6 py-5"
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white">Nouvelle Taxe</h3>
            ...
            <div className="overflow-y-auto max-h-[70vh] p-6 space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <ValidatedInput
                    icon={Landmark} label="Taxe" required
                    name="reference" value={form.reference} onChange={handleChange}
                    placeholder="Libellé de la taxe" className="w-full"
                  ...
                  <div>
                    ...
                    <select name="vehicle" value={form.vehicle} onChange={handleChange}
                      ...
                      {(vehiclesData?.data || []).map((v: any) => (
                        <option key={v._id} value={v._1}>{v.matricule} — {v.brand} {v.model}</option>
                      ))}
                    </select>
              ...
              <div className="border border-gray-100 rounded-xl p-4 space-y-4 bg-gray-50/50">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input type="number" min="0" step="0.01" name="montant" value={form.montant} onChange={handleChange}
                      placeholder="0.00"
